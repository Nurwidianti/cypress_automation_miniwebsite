const dijkstrajs = (() => {
  ...
  !(function (r) {
    var t = {
      single_source_shortest_paths: function (r, e, o) {
        var s = {},
          u = {};
        u[e] = 0;
        var i,
          ...
          _,
          f,
          c = t.PriorityQueue.make();
        for (c.push(e, 0); !c.empty(); ) {
          for (a in ((n = (i = c.pop()).value), (p = i.cost), (h = r[n] || {}))) {
            h.hasOwnProperty(a) &&
              ((_ = p + h[a]),
              (f = u[a]),
              (void 0 === u[a] || f > _) &&
                ((u[a] = _), c.push(a, _), (s[a] = n)));
          }
        }
      ...
      find_path: function (r, e, o) {
        var s = t.single_source_shortest_paths(r, e, o);
      ...
      PriorityQueue: {
        make: function (r) {
          ...
          return (s.queue = []), (s.sorter = r.sorter || o.default_sorter), s;
        },
        default_sorter: function (r, t) {
          return r.cost - t.cost;
        },
        push: function (r, t) {
          var e = {value: r, cost: t};
  ...
  var t = r.exports,
    e = r.exports.PriorityQueue,
    o = r.exports.extract_shortest_path_from_predecessor_list,
    s = r.exports.find_path,
    u = r.exports.single_source_shortest_paths;
  return {
    PriorityQueue: e,
    default: t,
    extract_shortest_path_from_predecessor_list: o,
    find_path: s,
    single_source_shortest_paths: u,
  };
})();
...
const qrcode = ((t) => {
  ...
  (l.prototype.set = function (t, e, n, r) {
    ...
    (l.prototype.xor = function (t, e, n) {
  ...
  !(function (t) {
    ...
    (t.getRowColCoords = function (t) {
      ...
      const n = Math.floor(t / 7) + 2,
        r = e(t),
        o = r === 145 ? 26 : 2 * Math.ceil((r - 13) / (2 * n - 2)),
        i = [r - 7];
      for (let t = 1; t < n - 1; t++) {
        i[t] = i[t - 1] - o;
      }
  ...
  (M.prototype.initialize = function (t) {
    (this.degree = t), (this.genPoly = v.generateECPolynomial(this.degree));
  }),
  ...
  U = U.replace(/u/g, '\\u');
  const S = '(?:(?![A-Z0-9 $%*+\\-./:]|' + U + ')(?:.|[\r\n]))+';
  (R.KANJI = new RegExp(U, 'g')),
    (R.BYTE_KANJI = new RegExp('[^A-Z0-9 $%*+\\-./:]+', 'g')),
    (R.BYTE = new RegExp(S, 'g')),
    (R.NUMERIC = new RegExp(L, 'g')),
    (R.ALPHANUMERIC = new RegExp('[A-Z $%*+\\-./:]+', 'g'));
  const x = new RegExp('^' + U + '$'),
    k = new RegExp('^' + L + '$'),
    F = new RegExp('^[A-Z0-9 $%*+\\-./:]+$');
        ...
        (t.getBestVersionForData = function (e, n) {
          ...
          if (Array.isArray(e)) {
            if (e.length > 1) {
              return (function (e, n) {
                for (let r = 1; r <= 40; r++) {
                  if (l(e, r) <= t.getCapacity(r, n, i.MIXED)) {
                    return r;
                  }
                }
              })(e, s);
  ...
  var z = {};
  const D = r,
    H = D.getBCHDigit(1335);
  z.getEncodedBits = function (t, e) {
    const n = (t.bit << 3) | e;
    let r = n << 10;
    for (; D.getBCHDigit(r) - H >= 0; ) {
      r ^= 1335 << (D.getBCHDigit(r) - H);
    }
    return 21522 ^ ((n << 10) | r);
  };
  var J = {};
  ...
  function Z(t) {
    (this.mode = q.BYTE),
      (this.data =
        typeof t === 'string' ? new TextEncoder().encode(t) : new Uint8Array(t));
  }
  ...
  !(function (e) {
    ...
    function g(t) {
      const e = h(u.NUMERIC, n.NUMERIC, t),
        r = h(u.ALPHANUMERIC, n.ALPHANUMERIC, t);
      let o, i;
      c.isKanjiModeEnabled()
        ? ((o = h(u.BYTE, n.BYTE, t)), (i = h(u.KANJI, n.KANJI, t)))
        : ((o = h(u.BYTE_KANJI, n.BYTE, t)), (i = []));
      return e
        .concat(r, o, i)
        .sort(function (t, e) {
    ...
    function p(t, e) {
      let r;
      const u = n.getBestModeForData(t);
            ...
            for (let r = 0; r < t.length; r++) {
              ...
              switch (o.mode) {
                ...
                case n.ALPHANUMERIC:
                  ...
                  break;
                case n.KANJI:
                  e.push([o, {data: o.data, mode: n.BYTE, length: f(o.data)}]);
                  break;
                case n.BYTE:
                  e.push([{data: o.data, mode: n.BYTE, length: f(o.data)}]);
              }
            }
            return e;
              ...
              for (let t = 0; t < a.length; t++) {
                ...
                for (let t = 0; t < i.length; t++) {
                  ...
                  r[s] && r[s].node.mode === c.mode
                    ? ((o[s][l] =
                        d(r[s].lastCount + c.length, c.mode) -
                        d(r[s].lastCount, c.mode)),
  ...
  function pt(t, e, n) {
    ...
    const o =
      8 * (et.getSymbolTotalCodewords(t) - ut.getTotalCodewordsCount(t, e));
    for (
    ...
    return (function (t, e, n) {
      const r = et.getSymbolTotalCodewords(e),
        o = ut.getTotalCodewordsCount(e, n),
        i = r - o,
        s = ut.getBlocksCount(e, n),
        a = r % s,
        u = s - a,
        c = Math.floor(r / s),
        l = Math.floor(i / s),
  ...
  function wt(t, e, n, r) {
    ...
    if (Array.isArray(t)) {
      ...
      }
      {
        let r = e;
        if (!r) {
          const e = gt.rawSplit(t);
          r = lt.getBestVersionForData(e, n);
        }
        o = gt.fromString(t, r || 40);
      }
    }
    const i = lt.getBestVersionForData(o, n);
    if (!i) {
    ...
    return (
      ...
      (function (t, e) {
        const n = it.getPositions(e);
        for (let e = 0; e < n.length; e++) {
          const r = n[e][0],
            o = n[e][1];
          for (let e = -2; e <= 2; e++) {
            for (let n = -2; n <= 2; n++) {
              e === -2 || e === 2 || n === -2 || n === 2 || (e === 0 && n === 0)
                ? t.set(r + e, o + n, !0, !0)
                : t.set(r + e, o + n, !1, !0);
            }
          }
      ...
      isNaN(r) && (r = at.getBestMask(u, dt.bind(null, u, n))),
      at.applyMask(r, u),
      dt(u, n, r),
      {
        modules: u,
  ...
  n.create = function (t, e) {
    ...
    return (
      void 0 !== e &&
        ((o = nt.from(e.errorCorrectionLevel, nt.M)),
        (n = lt.from(e.version)),
        (r = at.from(e.maskPattern)),
  ...
  !(function (t) {
    ...
    (t.getOptions = function (t) {
      t || (t = {}), t.color || (t.color = {});
      const n =
          void 0 === t.margin || t.margin === null || t.margin < 0 ? 4 : t.margin,
  ...
  yt.render = function (t, e, n) {
    const r = At.getOptions(e),
      o = t.modules.size,
      i = t.modules.data,
      s = o + 2 * r.margin,
      a = r.color.light.a
        ? '<path ' +
          Ct(r.color.light, 'fill') +
          ' d="M0 0h' +
          s +
          'v' +
          s +
          ...
          for (let a = 0; a < t.length; a++) {
            ...
            u || i || (i = !0),
              t[a]
                ? (s++,
                  (a > 0 && u > 0 && t[a - 1]) ||
                    ((r += i ? Bt('M', u + n, 0.5 + c + n) : Bt('m', o, 0)),
                    (o = 0),
                    (i = !1)),
                  (u + 1 < e && t[a + 1]) || ((r += Bt('h', s)), (s = 0)))
                : o++;
          }
          return r;
        })(i, o, r.margin) +
  ...
  var Pt = (e.create = vt.create),
    bt = (e.toCanvas = Nt.bind(null, Mt.render)),
    Rt = (e.toDataURL = Nt.bind(null, Mt.renderToDataURL)),
    Lt = (e.toString = Nt.bind(null, function (t, e, n) {

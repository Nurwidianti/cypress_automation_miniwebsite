            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h3><i class="cil-description"></i> {{ __('TAMBAH PURCHASE ORDER') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('logdoc.poDocPerVendor.upload') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table class="table table-sm" id="divFormatCp" name="divFormatCp" style="display: none">
                                <tr id="tanggalContainerCp" name="tanggalContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="date" name="tanggalCp" id="tanggalCp">
                                        <input class="form-control" type="hidden" name="hariCp" id="hariCp">
                                    </th>
                                </tr>
                                <tr id="regionContainerCp" name="regionContainerCp">
                                    ...
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <input class="form-control" type="text" id="regionTextCp" name="regionTextCp" hidden>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="kontrakContainerCp" name="kontrakContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="kontrakCp" id="kontrakCp" readonly>
                                    </th>
                                </tr>
                                <tr id="namaPeternakContainerCp" name="namaPeternakContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" id="namaPeternakCp" name="namaPeternakCp" readonly/>
                                    </th>
                                </tr>
                                <tr id="alamatKandangContainerCp" name="alamatKandangContainerCp">
                                    ...
                                    <th>
                                        <div class="input-group">
                                            <textarea class="form-control" name="alamatKandangCp" id="alamatKandangCp" rows="2" readonly></textarea>
                                ...
                                <tr id="nomorTeleponContainerCp" name="nomorTeleponContainerCp">
                                    ...
                                    <th>
                                        @if (($roles == 'pusat') || ($roles == 'admin'))
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="nomorTeleponCp" id="nomorTeleponCp" readonly><span class="input-group-append">
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="nomorTeleponCp" id="nomorTeleponCp" readonly>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="plastikVaccContainerCp" name="plastikVaccContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="number" class="form-control" name="plastikVaccCp" id="plastikVaccCp" value="0" />
                                    </th>
                                </tr>
                                <tr id="plastikNonVaccContainerCp" name="plastikNonVaccContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="number" class="form-control" name="plastikNonVaccCp" id="plastikNonVaccCp" disabled/>
                                    </th>
                                </tr>
                                ...
                                <tr id="keteranganContainerCp" name="keteranganContainerCp">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <textarea class="form-control" name="keteranganCp" id="keteranganCp" rows="2"></textarea>
                                    </th>
                                </tr>
                            </table>
                            <table class="table table-sm" id="divFormatCtu" name="divFormatCtu" style="display: none">
                                <tr id="regionContainerCtu" name="regionContainerCtu">
                                    ...
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <input class="form-control" type="hidden" id="regionTextCtu" name="regionTextCtu">
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="tanggalContainerCtu" name="tanggalContainerCtu">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="date" name="tanggalCtu" id="tanggalCtu">
                                        <input class="form-control" type="hidden" name="hariCtu" id="hariCtu">
                                    </th>
                                </tr>
                                ...
                                <tr id="kontrakContainerCtu" name="kontrakContainerCtu">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="kontrakCtu" id="kontrakCtu" readonly>
                                    </th>
                                </tr>
                                <tr id="namaPeternakContainerCtu" name="namaPeternakContainerCtu">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" id="namaPeternakCtu" name="namaPeternakCtu" readonly/>
                                    </th>
                                </tr>
                                <tr id="alamatContainerCtu" name="alamatContainerCtu">
                                    ...
                                    <th>
                                        <div class="input-group">
                                            <textarea class="form-control" name="alamatCtu" id="alamatCtu" rows="2" readonly></textarea>
                                ...
                                <tr id="nomorHpContainerCtu" name="nomorHpContainerCtu">
                                    ...
                                    <th>
                                        @if (($roles == 'pusat') || ($roles == 'admin'))
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="nomorHpCtu" id="nomorHpCtu" readonly><span class="input-group-append">
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="nomorHpCtu" id="nomorHpCtu" readonly>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="popBoxContainerCtu" name="popBoxContainerCtu">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="number" class="form-control" name="popBoxCtu" id="popBoxCtu" value="0">
                                    </th>
                                </tr>
                                <tr id="keteranganContainerCtu" name="keteranganContainerCtu">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <textarea class="form-control" name="keteranganCtu" id="keteranganCtu" rows="2"></textarea>
                                    </th>
                                </tr>
                            </table>
                            <table class="table table-sm" id="divFormatMb" name="divFormatMb" style="display: none">
                                <tr id="tanggalContainerMb" name="tanggalContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="date" name="tanggalMb" id="tanggalMb">
                                    </th>
                                </tr>
                                <tr id="hariContainerMb" name="hariContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="text" name="hariMb" id="hariMb" readonly>
                                    </th>
                                </tr>
                                <tr id="regionContainerMb" name="regionContainerMb">
                                    ...
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <input class="form-control" type="hidden" id="regionTextMb" name="regionTextMb">
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="jenisGradeContainerMb" name="jenisGradeContainerMb">
                                    <th style="width: 20%"> JENIS </th>
                                    <th style="width: 10px"> : </th>
                                    <th>
                                ...
                                <tr id="kontrakContainerMb" name="kontrakContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="kontrakMb" id="kontrakMb" readonly>
                                    </th>
                                </tr>
                                <tr id="namaPeternakContainerMb" name="namaPeternakContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" id="namaPeternakMb" name="namaPeternakMb" readonly/>
                                    </th>
                                </tr>
                                <tr id="alamatLokasiContainerMb" name="alamatLokasiContainerMb">
                                    ...
                                    <th>
                                        <div class="input-group">
                                            <textarea class="form-control" name="alamatLokasiMb" id="alamatLokasiMb" rows="2" readonly></textarea>
                                ...
                                <tr id="nomorTeleponContainerMb" name="nomorTeleponContainerMb">
                                    ...
                                    <th>
                                        @if (($roles == 'pusat') || ($roles == 'admin'))
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="nomorTeleponMb" id="nomorTeleponMb" readonly><span class="input-group-append">
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="nomorTeleponMb" id="nomorTeleponMb" readonly>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="jumlahBoxContainerMb" name="jumlahBoxContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="jumlahBoxMb" id="jumlahBoxMb" value="0">
                                    </th>
                                </tr>
                                ...
                                <tr id="keteranganContainerMb" name="keteranganContainerMb">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <textarea class="form-control" name="keteranganMb" id="keteranganMb" rows="2"></textarea>
                                    </th>
                                </tr>
                            </table>
                            <table class="table table-sm" id="divFormatDmc" name="divFormatDmc" style="display: none">
                                <tr id="regionContainerDmc" name="regionContainerDmc">
                                    ...
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <input class="form-control" type="hidden" id="regionTextDmc" name="regionTextDmc">
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="tanggalContainerDmc" name="tanggalContainerDmc">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="date" name="tanggalDmc" id="tanggalDmc">
                                        <input class="form-control" type="hidden" name="hariDmc" id="hariDmc">
                                    </th>
                                </tr>
                                ...
                                <tr id="kontrakContainerDmc" name="kontrakContainerDmc">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="kontrakDmc" id="kontrakDmc" readonly>
                                    </th>
                                </tr>
                                <tr id="namaFlokContainerDmc" name="namaFlokContainerDmc">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" id="namaFlokDmc" name="namaFlokDmc" readonly>
                                    </th>
                                </tr>
                                <tr id="alamatContainerDmc" name="alamatContainerDmc">
                                    ...
                                    <th>
                                        <div class="input-group">
                                            <textarea class="form-control" name="alamatDmc" id="alamatDmc" rows="2" readonly></textarea>
                                ...
                                <tr id="nomorTeleponContainerDmc" name="nomorTeleponContainerDmc">
                                    ...
                                    <th>
                                        @if (($roles == 'pusat') || ($roles == 'admin'))
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="nomorTeleponDmc" id="nomorTeleponDmc" readonly><span class="input-group-append">
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="nomorTeleponDmc" id="nomorTeleponDmc" readonly>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="popBoxContainerDmc" name="popBoxContainerDmc">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="popBoxDmc" id="popBoxDmc" value="0">
                                    </th>
                                </tr>
                                <tr id="keteranganContainerDmc" name="keteranganContainerDmc">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <textarea class="form-control" name="keteranganDmc" id="keteranganDmc" rows="2"></textarea>
                                    </th>
                                </tr>
                            </table>
                            <table class="table table-sm" id="divFormatSreeya" name="divFormatSreeya" style="display: none">
                                <tr id="tanggalContainerSreeya" name="tanggalContainerSreeya">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input class="form-control" type="date" name="tanggalSreeya" id="tanggalSreeya">
                                        <input class="form-control" type="hidden" name="hariSreeya" id="hariSreeya">
                                    </th>
                                </tr>
                                <tr id="regionContainerSreeya" name="regionContainerSreeya">
                                    ...
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <input class="form-control" type="hidden" id="regionTextSreeya" name="regionTextSreeya">
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="kontrakContainerSreeya" name="kontrakContainerSreeya">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="kontrakSreeya" id="kontrakSreeya" readonly>
                                    </th>
                                </tr>
                                <tr id="namaFlokContainerSreeya" name="namaFlokContainerSreeya">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" id="namaFlokSreeya" name="namaFlokSreeya" readonly/>
                                    </th>
                                </tr>
                                <tr id="alamatContainerSreeya" name="alamatContainerSreeya">
                                    ...
                                    <th>
                                        <div class="input-group">
                                            <textarea class="form-control" name="alamatSreeya" id="alamatSreeya" rows="2" readonly></textarea>
                                ...
                                <tr id="nomorTeleponContainerSreeya" name="nomorTeleponContainerSreeya">
                                    ...
                                    <th>
                                        @if (($roles == 'pusat') || ($roles == 'admin'))
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="nomorTeleponSreeya" id="nomorTeleponSreeya" readonly><span class="input-group-append">
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="nomorTeleponSreeya" id="nomorTeleponSreeya" readonly>
                                        @endif
                                    </th>
                                </tr>
                                ...
                                <tr id="popBoxContainerSreeya" name="popBoxContainerSreeya">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <input type="text" class="form-control" name="popBoxSreeya" id="popBoxSreeya" value="0">
                                    </th>
                                </tr>
                                <tr id="keteranganContainerSreeya" name="keteranganContainerSreeya">
                                    ...
                                    <th style="width: 10px"> : </th>
                                    <th>
                                        <textarea class="form-control" name="keteranganSreeya" id="keteranganSreeya" rows="2"></textarea>
                                    </th>
                                </tr>
                            </table>
                            <div class="modal-footer">
                                <a href="{{ url()->previous() }}" class="btn btn-danger mr-2">KEMBALI</a>
                                <button type="submit" class="btn btn-success" id="formSubmitButton" name="formSubmitButton">SIMPAN</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered datatable" id="cariDataPeternakTable">
                        <thead>
                            <tr>
                                ...
                                <th>ALAMAT</th>
                                <th>NOMOR</th>
                                <th style="max-width:150px" class="text-center">AKSI</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#cariDataPeternakTable').DataTable({
            ...
            columns: [
                { data: 'no_urut', name: 'no_urut', orderable: false, searchable: false },
    ...
    $('#formSubmitButton').click(function(event) {
        ...
        if (vendor.includes('CP')) {
            var kontrakField = $('#kontrakCp').val();
        } else if (vendor.includes('MB')) {
            var kontrakField = $('#kontrakMb').val();
        } else if (vendor.includes('DMC')) {
            var kontrakField = $('#kontrakDmc').val();
        } else if (vendor.includes('SREEYA')) {
            var kontrakField = $('#kontrakSreeya').val();
        } else {
            var kontrakField = $('#kontrakCtu').val();
        }

        if (kontrakField == 'BELUM KONTRAK') {
            event.preventDefault();
            Swal.fire({
                title: 'Gagal',
                text: 'PO DOC tidak bisa dilanjutkan karena peternak Belum Kontrak.',
                icon: 'error',
    ...
    $('select[name="vendor"]').change(function () {
        ...
        const clearFields = (fields) => {
            fields.forEach((field) => {
                ...
                if (element.is('select')) {
                    // Cek apakah id atau name mengandung kata 'unit'
                    const idContainsUnit = element.attr('id')?.includes('unit');
                    const nameContainsUnit = element.attr('name')?.includes('unit');

                    if (idContainsUnit || nameContainsUnit) {
                        // Kosongkan option dan sisakan hanya satu opsi dengan value kosong
                        element.empty().append('<option value="" selected hidden>PILIH</option>');
                    } else {
                        element.val(''); // Jika tidak mengandung 'unit', kosongkan nilai
                    }
                } else if (element.is(':input')) {
                    element.val(''); // Untuk <input>, <textarea>, dll., kosongkan nilai
                }

                element.removeAttr('required'); // Hapus atribut 'required'
            });
        };
        ...
        const fields = {
            cp: ['#tanggalCp', '#regionCp', '#unitCp', '#jenisGradeCp', '#namaPeternakCp', '#alamatKandangCp', '#nomorTeleponCp', '#nomorTeleponTSCp', '#plastikVaccCp', '#plastikNonVaccCp', '#feedGelCp'],
            mb: ['#tanggalMb', '#hariMb', '#regionMb', '#unitMb', '#jenisGradeMb', '#jenisVaksinMb', '#namaPeternakMb', '#alamatLokasiMb', '#nomorTeleponMb', '#nomorTeleponTSMb', '#jumlahBoxMb', '#boxPlastikMb', '#perlakuanMb'],
            dmc: ['#regionDmc', '#unitDmc', '#tanggalDmc', '#jenisGradeDmc', '#jenisVaksinDmc', '#namaFlokDmc', '#alamatDmc', '#nomorTeleponDmc', '#nomorTeleponTSDmc', '#popBoxDmc'],
            sreeya: ['#tanggalSreeya', '#regionSreeya', '#unitSreeya', '#jenisGradeSreeya', '#jenisVaksinSreeya', '#namaFlokSreeya', '#alamatSreeya', '#nomorTeleponSreeya', '#nomorTeleponTSSreeya', '#popBoxSreeya'],
            ctu: ['#regionCtu', '#unitCtu', '#tanggalCtu', '#jenisGradeCtu', '#namaPeternakCtu', '#alamatCtu', '#nomorHpCtu', '#nomorTeleponTSCtu', '#popBoxCtu'],
        };

        if ('{{ $roles }}' == 'pusat' || '{{ $roles }}' == 'admin') {
            // Reset all fields
            Object.values(fields).forEach(clearFields);
        }

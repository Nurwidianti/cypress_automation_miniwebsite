                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>
                                <i class="cil-description"></i>{{ __(' PO DOC (ARSIP)') }}
                                <button type="button" class="btn btn-primary float-lg-right" onclick="window.location='{{ url('logdoc/poDocPerVendor') }}'">KEMBALI</button>
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-8">
                                    <form class="row d-flex justify-content-start form-inline" action="{{ route('logdoc.poDocPerVendor.arsip') }}" method="get" style="margin-top:10px; margin-bottom: 10px">@csrf
                                                            ...
                                                            @foreach($poDocFilter as $data)
                                                                @if ($data->hari == $day)
                                                                    <tr>
                                                                        ...
                                                                        <td style="border: 1px solid #000000; text-align: center">{{ $data->gradeflok }}</td>
                                                                        <td style="border: 1px solid #000000; text-align: center">{{ $data->ring }}</td>
                                                                        <td style="border: 1px solid #000000; text-align: center">{{ $data->density }}</td>
                                                                        <td style="border: 1px solid #000000; text-align: center">{{ $data->jeniskandang }}</td>
                                                                        <td style="border: 1px solid #000000;">{{ $data->prasyaratperkandangan }}</td>
                                                                        <td style="border: 1px solid #000000;">{{ $data->prasyaratkelistrikan }}</td>
                                                                        <td style="border: 1px solid #000000;">{{ $data->prasyarattotal }}</td>
                                                                        <td style="border: 1px solid #000000; text-align: center;"><span style="font-size:24px;">{{ $data->alatchalarm == 'Ada' ? html_entity_decode('&#9989;') : ($data->jeniskandang == 'CH' ? html_entity_decode('&#10060;') : '---') }}</span></td>
                                                                        <td style="border: 1px solid #000000; text-align: center;"><span style="font-size:24px;">{{ $data->alatchgenset == 'Ada' ? html_entity_decode('&#9989;') : ($data->jeniskandang == 'CH' ? html_entity_decode('&#10060;') : '---') }}</span></td>
                                                                        <td style="border: 1px solid #000000;">
                                                                            <b class="{{ in_array($data->hasilpo, ['REKOMENDASI KANIT', 'REKOMENDASI DIREKTUR', 'PERJANJIAN GANTI RUGI']) ? 'text-danger' : '' }}">{{ $data->hasilpo }}</b>
                                                                            @if (in_array($data->hasilpo, ['REKOMENDASI KANIT', 'REKOMENDASI DIREKTUR', 'PERJANJIAN GANTI RUGI']))
                                                                                <br>
